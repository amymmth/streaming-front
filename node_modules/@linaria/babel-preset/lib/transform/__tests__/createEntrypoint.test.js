...
var _entrypointHelpers = require("./entrypoint-helpers");
describe('createEntrypoint', () => {
  ...
  it('should invalidate cache if source code was changed', () => {
    const entrypoint1 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['default'], 'foo');
    const entrypoint2 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['default'], 'bar');
  ...
  it('should not take from cache if path differs', () => {
    const entrypoint1 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['default']);
    const entrypoint2 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/baz.js', ['default']);
    expect(entrypoint1).not.toBe(entrypoint2);
  ...
  it('should not take from cache if only differs', () => {
    const entrypoint1 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['default']);
    const entrypoint2 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['named']);
    expect(entrypoint1).not.toBe(entrypoint2);
    expect(entrypoint1.supersededWith).toBe(entrypoint2);
    expect(entrypoint2).toMatchObject({
      name: '/foo/bar.js',
  ...
  it('should take from cache if only is subset of cached', () => {
    const entrypoint1 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['default', 'named']);
    const entrypoint2 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['default']);
    expect(entrypoint1).toBe(entrypoint2);
  });
  it('should take from cache if wildcard is cached', () => {
    const entrypoint1 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['*']);
    const entrypoint2 = (0, _entrypointHelpers.createEntrypoint)(services, '/foo/bar.js', ['default']);
    expect(entrypoint1).toBe(entrypoint2);
  });
...
//# sourceMappingURL=createEntrypoint.test.js.map