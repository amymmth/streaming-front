...
var _shakerPlugin = _interopRequireDefault(require("../shaker-plugin"));
...
const keep = (only, extension = 'js') => (code, ...args) => {
  ...
  if (!transformed || !transformed.code || !(0, _utils.hasEvaluatorMetadata)(transformed.metadata)) {
