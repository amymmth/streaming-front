...
import type { Intensities } from "./models/intensities.model.ts"
...
export const AudioPlayer: FC<AudioPlayerProps> = (props: AudioPlayerProps) => {
    ...
    return (
        <div className="flex items-center relative z-10">
            ...
            {/*/>*/}
            <Slider min={0} max={duration} value={currentTime} onChange={(value) => handleSliderChange(value as number)} />

            <div className="flex justify-between text-sm text-white/80 absolute inset-0 px-2 items-center select-none pointer-events-none">
